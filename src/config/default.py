...
# _CN.LOFTR.BACKBONE_TYPE = 'DaViTFPN'
# _CN.LOFTR.BACKBONE_TYPE = 'MaxViTFPN'
...
_CN.LOFTR.RESNETFPN.BLOCK_DIMS = [128, 196, 256, 512]  # s1, s2, s3

# 1.1 DaVitFPN-backbone (local feature CNN) config
# _CN.LOFTR.DAVITFPN = CN()
# _CN.LOFTR.DAVITFPN.IN_CHANS = 1
# _CN.LOFTR.DAVITFPN.PATCH_SIZE = 2
# _CN.LOFTR.DAVITFPN.EMBED_DIMS = (128,192,256,512)
# _CN.LOFTR.DAVITFPN.NUM_HEADS = (8,8,8,8)
# _CN.LOFTR.DAVITFPN.DEPTHS=(1,1,2,1)
_CN.LOFTR.DAVITFPN = CN()
_CN.LOFTR.DAVITFPN.IN_CHANS = 1
_CN.LOFTR.DAVITFPN.PATCH_SIZE = 2
_CN.LOFTR.DAVITFPN.EMBED_DIMS = (128,192,256,320)
_CN.LOFTR.DAVITFPN.NUM_HEADS = (2,4,8,8)
_CN.LOFTR.DAVITFPN.DEPTHS=(1,1,1,1)

_CN.LOFTR.MAXVITFPN = CN()
_CN.LOFTR.MAXVITFPN.IN_CHANS = 1
_CN.LOFTR.MAXVITFPN.DIMS = (128,192,256,320)
_CN.LOFTR.MAXVITFPN.DEPTHS=(1,1,2,1)   
...
# _CN.LOFTR.COARSE.LAYER_NAMES = ['wgself', 'cross'] * 4
_CN.LOFTR.COARSE.LAYER_NAMES = ['tkwself2', 'tkwcross2'] * 4
_CN.LOFTR.COARSE.ATTENTION = 'linear'  # options: ['linear', 'full']
_CN.LOFTR.COARSE.TEMP_BUG_FIX = True

# 3. Coarse-Matching config
_CN.LOFTR.MATCH_COARSE = CN()
_CN.LOFTR.MATCH_COARSE.THR = 0.10
